"""cityscapes image to image translation ​using Pix2Pix GAN
cityscapes Data from: http://efrosgans.eecs.berkeley.edu/pix2pix/datasets/
"""
...
def load_images(path, size=(256,512)):
	...
	for filename in listdir(path):
		...
		train_img, val_img = pixels[:, :256], pixels[:, 256:]
		src_list.append(train_img)
		tar_list.append(val_img)
	return [asarray(src_list), asarray(tar_list)]

# dataset path
path = 'C:/Users/KUSHI REDDY/Downloads/cityscapes/cityscapes/train/'
# load dataset
